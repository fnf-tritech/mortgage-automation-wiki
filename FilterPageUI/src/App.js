...
const App = () => {
  ...
  const tableData = [
    { id: 1, name: 'Gopal Reddy', mortgage: 250000, date: '15-10-2021', riskAnalysis: 'Low', wishlist: false },
    { id: 2, name: 'Suchit J', mortgage: 350000, date: '11-01-2022', riskAnalysis: 'Medium', wishlist: true },
    ...
    { id: 5, name: 'Anushka Gupta', mortgage: 150000, date: '19-08-2020', riskAnalysis: 'High', wishlist: true },
    { id: 6, name: 'Aditya A P', mortgage: 230000, date: '08-12-2023', riskAnalysis: 'Low', wishlist: false },
    { id: 7, name: 'Jeevan K C', mortgage: 150000, date: '17-03-2023', riskAnalysis: 'Medium', wishlist: true },
    ...
    { id: 10, name: 'Sanchita J Ellur', mortgage: 190000, date: '20-11-2016', riskAnalysis: 'Medium', wishlist: true },
    { id: 11, name: 'Shaghil Khan', mortgage: 280000, date: '02-12-2017', riskAnalysis: 'High', wishlist: false },
    { id: 12, name: 'Vijesh Srimal', mortgage: 550000, date: '13-11-2018', riskAnalysis: 'Low', wishlist: true },
    { id: 13, name: 'Mohammed Saqheeb', mortgage: 650000, date: '14-06-2019', riskAnalysis: 'High', wishlist: false },
    { id: 14, name: 'Sai Sharan Reddy', mortgage: 680000, date: '17-05-2020', riskAnalysis: 'Low', wishlist: false },
    { id: 15, name: 'Shreyas Javalli', mortgage: 920000, date: '18-01-2023', riskAnalysis: 'Medium', wishlist: false },
    { id: 16, name: 'Ravi Kumar', mortgage: 950000, date: '15-05-2022', riskAnalysis: 'Low', wishlist: true },
    { id: 17, name: 'Leon H K', mortgage: 250700, date: '17-09-2021', riskAnalysis: 'Low', wishlist: false },
    { id: 18, name: 'Deepak A C', mortgage: 230000, date: '18-11-2019', riskAnalysis: 'High', wishlist: true },
  ...
  if (selectedFilters.length > 0) {
    ...
    if (selectedFilters.includes('date')) {
      const startDate = new Date(filterRanges.startDate || '0000-01-01');
      const endDate = new Date(filterRanges.endDate || '9999-12-31');
      const filteredDates = tableData.filter((row) => {
        const currentDate = new Date(row.date);
        return currentDate >= startDate && currentDate <= endDate;
      });
      filteredData.push(...filteredDates);
    }
